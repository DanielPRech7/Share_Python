...
from sharepython.views import lobby_view, resumo_view, nova_tarefa_view, cadastrar_item_view, editar_tarefa_view, excluir_tarefa_view, atividades_view, cadastrar_atividade_view
